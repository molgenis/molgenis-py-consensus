...
public class ClinVarSetHandler extends DefaultHandler {
  ...
  public void startElement(String uri, String localName, String qName,
    ...
    if (qName.equals(CLIN_VAR_ASSERTION)) {
      ...
      parseClinVarAssertion(qName, attributes);
    }
  }

  private void parseClinVarAssertion(String qName, Attributes attributes) {
  ...
  private void endElementClinVarAssertion() {
    if (results == null) {
      results = new ArrayList<>();
    }
    if (isVkgl) {
